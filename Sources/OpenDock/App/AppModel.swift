...
public final class AppModel: ObservableObject {
    ...
    func moveRunningApp(_ app: RunningAppInfo, to display: DisplayInfo) {
        ...
        case .noWindows:
            NSLog("\(AppIdentity.displayName): no visible windows found for \(app.localizedName)")
        case .failed:
            NSLog("\(AppIdentity.displayName): failed to move windows for \(app.localizedName)")
        }
    }
    ...
    func chooseApplicationToPin() {
        ...
        panel.message = "Choose an application to keep in \(AppIdentity.displayName)."
    ...
    func chooseFileOrFolderPins() {
        ...
        panel.message = "Choose files or folders to keep in \(AppIdentity.displayName)."
        panel.canChooseFiles = true
    ...
    func promptForURLPin() {
        ...
        alert.informativeText = "Enter the web URL to keep in \(AppIdentity.displayName)."
