...
final class DockVisibilityService {
    ...
    private let recoveryAgentLabel = "app.localsidebar.dock-restorer"
    ...
    init(fileManager: FileManager = .default) {
        ...
        let directory =
            ...
            .appendingPathComponent("Library/Application Support/LocalSidebar", isDirectory: true)
        self.snapshotURL =
            directory
    ...
    private func save(_ snapshot: DockVisibilitySnapshotV2) {
        do {
            ...
            NSLog("LocalSidebar: failed to save Dock snapshot: \(error.localizedDescription)")
        }
    }
    ...
    private func installRecoveryAgentIfPossible() {
        guard let helperURL = resolvedRestorerURL() else {
            NSLog("LocalSidebar: Dock restorer helper was not found")
            return
        }
        ...
        do {
            ...
            NSLog("LocalSidebar: failed to install Dock recovery agent: \(error.localizedDescription)")
        }
    }
    ...
    private func resolvedRestorerURL() -> URL? {
        ...
        let bundledHelper =
            ...
            .appendingPathComponent("LocalSidebarDockRestorer")
        ...
        let siblingHelper = executableDirectory.appendingPathComponent("LocalSidebarDockRestorer")
