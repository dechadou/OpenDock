...
@main
struct LocalSidebarUnitTestRunner {
    static func main() async {
        ...
        print("\nAll LocalSidebar unit tests passed")
    }

    @MainActor
    private static func testPreferencesPersist() throws {
        let suiteName = "LocalSidebarTests-\(UUID().uuidString)"
    ...
    private static func testLoginItemLaunchAgentPlist() throws {
        let appURL = URL(fileURLWithPath: "/Applications/LocalSidebar.app", isDirectory: true)
    ...
    private static func makeTemporaryDirectory() throws -> URL {
        let directory = FileManager.default.temporaryDirectory
            .appendingPathComponent("LocalSidebarTests-\(UUID().uuidString)", isDirectory: true)
